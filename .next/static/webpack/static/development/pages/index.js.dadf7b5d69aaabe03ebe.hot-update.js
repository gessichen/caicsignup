      ...
      if (this.formIsValid()) {
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://cicoins.io:8999/api/app/verify/signUpCode", {
          ...
          if (resBody.code === 5009) {
            ...
            window.location = "http://localhost:3000/signup?invitation=" + _this2.state.invitation_code + "&preMobile=" + _this2.state.preMobile + "";
          } else {
...
//# sourceMappingURL=index.js.dadf7b5d69aaabe03ebe.hot-update.js.map