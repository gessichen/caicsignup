      ...
      if (this.formIsValid()) {
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://cicoins.io:8999/api/app/verify/signUpCode", {
          ...
          if (resBody.code === 5009) {
            ...
            window.location = "http://localhost:3000/signup?invitation=" + _this2.state.invitation_code + "&preMobile=" + _this2.state.preMobile + "&mobile=" + _this2.state.mobile;
          } else {
...
//# sourceMappingURL=index.js.fcae46d8b897adf4481c.hot-update.js.map