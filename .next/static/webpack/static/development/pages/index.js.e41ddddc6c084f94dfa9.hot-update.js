...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Register, [{
    ...
    value: function submitForm(e) {
      ...
      e.preventDefault();
      window.location.href = "/signup?invitation=" + this.state.invitation_code + "&preMobile=" + this.state.preMobile + "&mobile=" + this.state.mobile;
      ...
      if (this.formIsValid()) {
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.post("http://cicoins.io:8999/api/app/verify/signUpCode", {
          ...
          if (resBody.code === 5009) {
            ...
            window.location.href = "/signup?invitation=" + _this2.state.invitation_code + "&preMobile=" + _this2.state.preMobile + "&mobile=" + _this2.state.mobile;
          } else {
...
function (_React$Component2) {
  ...
  function Index(props) {
    ...
    _this3 = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4__["default"])(Index).call(this, props));
    _this3.state = {};
    return _this3;
  }
...
//# sourceMappingURL=index.js.e41ddddc6c084f94dfa9.hot-update.js.map